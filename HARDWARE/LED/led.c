...
void LED_Init(void)
{
 ...
 RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOC, ENABLE);	 //使能PB,PE端口时钟
//PB	
...
GPIO_ResetBits(GPIOB,GPIO_Pin_10);//与430通信管脚0
GPIO_ResetBits(GPIOB,GPIO_Pin_11);//与430通信管脚1

GPIO_ResetBits(GPIOB,GPIO_Pin_12);//语音开关，置0,切到模拟语音
...
//PC
 ...
 GPIO_ResetBits(GPIOC,GPIO_Pin_9);//安全芯片供电。0：停电；1：供电； 
